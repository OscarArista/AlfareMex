...
<!--div class="conatiner">
    <div class="form">
        ...
        <div class="contact-form">
            <form method="POST" action="{{ route('clientts') }}" autocomplete="off">
            @csrf
              <p class="contact_tittle">Nombre</p>
                <div class="input-container">
                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('email') }}" required autocomplete="email" placeholder="NOMBRE" autofocus>
                        @error('email')
                ...
                <div class="input-container">
                    <input id="correo" type="email" class="form-control @error('correo') is-invalid @enderror" name="correo" value="{{ old('correo') }}" required autocomplete="correo" placeholder="EMAIL" autofocus>
                        @error('correo')
                            <span class="invalid-feedback" role="alert">
                                <strong><h6 style="color:yellow;">{{ __('Por favor digite bien su usuario o contraseña') }}</h6></strong>
                            </span>
