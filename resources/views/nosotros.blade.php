            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <h4>ARTESANIA <span>-Sitio Web-</span></h4>
						<br>
						<br>
                        <h3 class="tipeo1">COMUNÍCATE CON NOSOTROS</h3>
...
<div class="nosotros_container">
    <div class="nosotros_card">
        ...
        <div class="nosotros_content">
            <div>
                <h3>¿Quienes somos?</h3>
                <p>AlfaMex diseñadores web esta pagina web esta para que asi fortalezcan sus conocimientos y que les ayude asus negocios.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="nosotros_card">
        <div class="nosotros_imbBx" data-text="¿Porque escogernos?">
            <i class="fas fa-5x fa-solid fa-thumbtack"></i>
