        ...
        <div class="wrapper">
            ...
            <aside class="main-sidebar bg-light elevation-4">
                ...
                <a href="{{ url('/') }}" class="brand-link">
                    <img src="{{ asset('img/ico.jpg')}}" alt="logo" class="brand-image img-circle"
                        style="opacity: .8">
                    <span class="brand-text font-weight-light">AlfareMex</span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="{{ asset('dist/img/avata.png')}}" class="img-circle elevation-2" alt="User Image">
                        </div>
                        <div class="info">
